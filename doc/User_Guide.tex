...
specified angle of attack), or `max-xtr' (to move the turbulent transition location as far
towards the trailing edge as possible).}
...
plotted using the design visualizer tool; see section \ref{sec:design_visualizer} for more
information.}
...
the ones shown in Fig. \ref{fig:design_visualizer_plot}.  However, as mentioned
...
\centering
  \subfloat[Airfoils]{
    \includegraphics[width=0.49\textwidth]{manual_figs/airfoil_plots.png}}
  \subfloat[Aerodynamics]{
    \includegraphics[width=0.49\textwidth]{manual_figs/aero_plots.png}}

  \subfloat[Optimization history]{
    \includegraphics[width=0.49\textwidth]{manual_figs/optimization_history.png}}
\caption{Example of plots generated by design\_visualizer.py.}
\label{fig:design_visualizer_plot}
\end{figure}

\section{Using the xfoil\_only tool}
...
input file as Xoptfoil, except that the many of the inputs are ignored. The relevant
...
You can find example cases and full descriptions of why particular inputs were chosen, how
to run them, and how to examine the outputs in the doc/example\_case directory included in
the Xoptfoil release.
